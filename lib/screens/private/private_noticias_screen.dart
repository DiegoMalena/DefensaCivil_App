...
class PrivateNoticiasScreen extends StatefulWidget {
  const PrivateNoticiasScreen ({Key? key}) : super(key: key);

  @override
  _PrivateNoticiasScreen  createState() => _PrivateNoticiasScreen ();
}

class _PrivateNoticiasScreen  extends State<PrivateNoticiasScreen > {
